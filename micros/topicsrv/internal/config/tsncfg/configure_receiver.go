...
type topicSrvConfigurationReceiver struct {
	cs *dnacos.ConfigureStorage
}

func NewTopicSrvConfigurationReceiver() dnacos.ConfigurationReceiver {
	return &topicSrvConfigurationReceiver{
		cs: dnacos.NewConfigureStorage(),
	}
}

func (scr *topicSrvConfigurationReceiver) OnReceiveStatic(dataId, groupName, data string) {
...
func (scr *topicSrvConfigurationReceiver) OnReceiveDynamic(dataId, groupName, data string, firstLoad bool) {
	_ = dnacos.LogWhenReceived(dataId, groupName, data, false, firstLoad)

}

func (scr *topicSrvConfigurationReceiver) RecentlyConfigure(dataId string) (any, bool) {
